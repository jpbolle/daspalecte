...
- Le projet a **deux implementations paralleles** : l'extension Chrome (`content.js`, `sidepanel.*`) et le module complementaire Docs/Sheets/Slides (`gas-addon/`), qui est un portage de la premiere.
...
- **App web (`web/`)** : Next.js + React + Tailwind, c'est l'exception assumee. La regle ci-dessus ne s'y applique pas
